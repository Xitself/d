...
-- Local references to various services and objects
...
if purchases then
    for i, item in ipairs(purchases:GetChildren()) do
        -- rest of your code here
    end
else
    warn("Purchases object not found in Workspace")
end
    ...
    Callback = function(value)
        ...
        Players.LocalPlayer.OnTeleport:Connect(function(State)
            if KeepNexus and (not TeleportCheck) and queueteleport then
                TeleportCheck = true
                queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/raditself/d/main/loadstring'))()")
            end
        end)
    end 
})
